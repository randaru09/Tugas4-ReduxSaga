  ...
  return(
    <View style = { styles.container }>
      ...
      <ScrollView style = { styles.card }>
        ...
        <TouchableOpacity onPress = {() => navigation.navigate('Datalist')}><Text style = { styles.search }
        >Cari</Text></TouchableOpacity>

        <TouchableOpacity onPress = {() => navigation.navigate('Saga')}><Text style = { styles.search }
        >Redux Saga</Text></TouchableOpacity>
      </ScrollView>
      
      <View style = { styles.footer }>
        <Text style = { styles.copyright }>Copyright Rangga Ndaru Anggoro - 1201400196</Text>
      </View>
    </View>
  );
}
